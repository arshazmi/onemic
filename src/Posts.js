                    ...
                    <div className="media p-3"> <img src={author} alt="John Doe" className="mr-3 rounded-circle" style={{ width: "86px" }} />
                        <div className="media-body">
                            ...
                            <div className="article-body">
                                ...
                                <div className="popup-images justify-content-start"> <a href="#" className="m-1">
                                    <img src={pic1} alt="pic" className="brd-rounded5 mb-2" /> </a> <a href="#" className="m-1">
                                        <img src={pic2} alt="pic" className="brd-rounded5 mb-2" /> </a> <a href="#" className="m-1">
                                        <img src={pic3} alt="pic" className="brd-rounded5 mb-2" /> </a> <a href="#" className="m-1">
                                        <img src={pic4} alt="pic" className="brd-rounded5 mb-2" /> </a> </div>
                            </div>
                        </div>
                    </div>
